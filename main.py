    ...
    try:
        ...
        if '/admin' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    bot.sendMessage(update.message.chat.id,'❌Error en el comando /admin username❌')
            else:
                bot.sendMessage(update.message.chat.id,'❌No Tiene Permiso❌')
            return
        if '/ban' in msgText:
        ...
        if '/type' in msgText:
            try:
                ...
                bot.sendMessage(update.message.chat.id,'❌Error en el comando /type (moodle o cloud)❌')
            return
        ...
        if '/start' in msgText:
            start_msg = '✅ Actualización 7.0 ✅\n'
            start_msg+= '👨🏻‍💻Desarrollador: @yordante\n'
            start_msg+= '👮🏻‍♂️Administrador: @yordante\n'
            start_msg+= '🔌Proxy: Opcional\n'
            start_msg+= '👨‍🔧Uso: Subir Archivos A La Nube'
...
def main():
    ...
    #set in debug
    bot_token = '5198908600:AAGsgcFoBKeqmPJlUSnvWdtG-kQTd_O1was'
